...
One further extension is to consider parameters a
...
require(rbiips)
library(MCMCpack)
model_file = '/home/gcgibson/Desktop/lyme_project/pois.bug' # BUGS model filename
...
qqnorm(ma_data-summ_pmmh$x$mean)
qqline(ma_data-summ_pmmh$x$mean)
...
require(rbiips)
library(MCMCpack)
model_file = '/home/gcgibson/Desktop/lyme_project/seasonal_pois.bug' # BUGS model filename
cat(readLines(model_file), sep = "\n")
...
#setting the mean value of the initial count to 1400
data = list(t_max=t_max, y = ma_data,  G = G, mean_sigma_init = c(0,0), cov_sigma_init=2000*diag(4) ,mean_x_init=c(log(1400),log(1400)))
model = biips_model(model_file, data=data,sample_data = FALSE)
...
require(rbiips)
library(MCMCpack)
model_file = '/home/gcgibson/Desktop/lyme_project/ar_dlm.bug' # BUGS model filename
cat(readLines(model_file), sep = "\n")
